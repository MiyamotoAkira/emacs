...
(setq treesit-language-source-alist
      '((bash "https://github.com/tree-sitter/tree-sitter-bash")
        ...
        (tsx "https://github.com/tree-sitter/tree-sitter-typescript" "v0.20.3" "src")
...
The apheleia package formats python, js and go by default
#+BEGIN_SRC emacs-lisp
...
This mode handles the black formatting for python
#+BEGIN_SRC emacs-lisp
(use-package blacken
